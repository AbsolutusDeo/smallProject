...
class Sitemap
{
    ...
    public static function saveInFile($filename,$content){
        $handle = fopen($filename, 'w');
        fwrite($handle, $content);
        fclose($handle);
        return htmlspecialchars("<h1><a rel='nofollow' content='noindex' href='"."/".$filename."'>Site Map</a></h1>");
    }

    //generates sitemap
    public function generate_sitemap(){
        $sitemap = new SimpleXMLElement('<urlset xmlns:ns1="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"></urlset>');
